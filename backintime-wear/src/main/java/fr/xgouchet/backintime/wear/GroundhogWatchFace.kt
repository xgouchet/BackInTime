 ...
 */
class GroundhogWatchFace : CanvasWatchFaceService() {
    ...
    private class EngineHandler(reference: GroundhogWatchFace.Engine) : Handler() {
        private val engineRef: WeakReference<GroundhogWatchFace.Engine> = WeakReference(reference)
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        private var renderer: GroundhogRenderer? = null
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(WatchFaceStyle.Builder(this@GroundhogWatchFace).build())

            calendar = Calendar.getInstance()
            renderer = GroundhogRenderer(this@GroundhogWatchFace)
        }
        ...
        private fun registerReceiver() {
            ...
            this@GroundhogWatchFace.registerReceiver(timeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@GroundhogWatchFace.unregisterReceiver(timeZoneReceiver)
        }
        // endregion
