...
public class Watch {
    ...
    public void setFormat12Hour(CharSequence format) {
        mFormat12 = format;
        Log.d("Watch", "setFormat12Hour(" + format + ")");
    ...
    public void setFormat24Hour(CharSequence format) {
        mFormat24 = format;
        Log.d("Watch", "setFormat24Hour(" + format + ")");
    ...
    private void chooseFormat(boolean handleTicker) {
        ...
        if (format24Requested) {
            Log.d("Watch", "chooseFormat24 " + mFormat24 + " / " + mFormat12 + " / default");
            mFormat = abc(mFormat24, mFormat12, DEFAULT_FORMAT_12_HOUR);
        } else {
            Log.d("Watch", "chooseFormat12 " + mFormat12 + " / " + mFormat24 + " / default");
        ...
        Log.d("Watch", "chooseFormat " + mFormat + " : hadSeconds?" + hadSeconds + " hasSeconds?" + mHasSeconds);
